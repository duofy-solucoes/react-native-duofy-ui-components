...
export const getStyles = props => {
  ...
  const incColor = plusDisabled ? tw.color(`brand-black-light`) : tw.color(`brand-primary`);
  const decColor = minusDisabled ? tw.color(`brand-black-light`) : tw.color(`brand-black-lighter`);
  return {
    container,
    input,
    incColor,
