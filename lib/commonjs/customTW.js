...
let tw = (0, _twrnc.create)();
try {
  tw = (0, _twrnc.create)(require('../../../tailwind.config.js'));
} catch {
  tw = (0, _twrnc.create)({
    content: ['*.{html,js,ts,tsx,css}', './src/**/*.{html,ts,tsx,js,jsx,css,scss}', './src/components/**/*.{html,ts,tsx,js,jsx,css,scss}'],
    theme: {
      extend: {
        colors: {
          brand: {
...
//# sourceMappingURL=customTW.js.map